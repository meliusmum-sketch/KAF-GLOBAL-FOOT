    ...
    <main>
      ...
      <section id="apropos" className="section">
        ...
        <p>
          ...
          Casamance (Sénégal). Nous accompagnons les jeunes joueurs de 14 à 23
          ans dans leur progression sportive et humaine.
        </p>
        <details className="details">
          <summary>Voir plus</summary>
          <p>
            Notre projet repose sur trois piliers : un encadrement sérieux, un
            cadre sécurisé et une vision éducative du football. Au-delà de la
            performance, nous cherchons à transmettre des valeurs fortes :
            respect, discipline, esprit d’équipe, goût de l’effort et sens des
            responsabilités.
          </p>
          <p>
            Les entraînements se déroulent du lundi au samedi sur le terrain du
            Lycée de Kafountine, avec un programme adapté à l’âge et au niveau
            de chaque joueur.
          </p>
          ...
          <p>
            The project is built on three main pillars: serious coaching, a safe
            environment and an educational vision of football. Beyond
      ...
      <section id="horaires" className="section">
        ...
        <div className="card">
          ...
          <p>
            Entraînements tous les jours sauf le dimanche. Les horaires peuvent
            légèrement varier en fonction du planning et des compétitions. En
            cas de changement, les joueurs et les parents sont informés à
            l’avance.
          </p>
        </div>
        ...
        <div className="card">
          ...
          <p>
            Crewane, Kafountine, département de Bignona, région de Ziguinchor
            (Casamance).
          </p>
          <p>
            Une carte Google Maps est disponible ci-dessous pour vous aider à
            trouver le terrain.
          </p>
        </div>
      </section>
